...
const apologyPhrases = {
    ...
    emotional_blackmail: {
        ...
        medium: [
            "每當想到這件事，我就徹夜難眠，胃口全無。",
            "我真的很珍惜我們之間的關係，請不要因此而疏遠我。",
            "想到您可能會因此對我改觀，我就感到無比痛苦。",
            "我已經好幾天吃不下飯，睡不好覺了。",
            "這幾天我的身體狀況都不太好，都是因為太過自責。"
        ],
        heavy: [
            "我已經連續幾天都在為這件事痛哭，無法原諒自己。",
            "如果您無法原諒我，我真的不知道該如何繼續下去。",
            "這幾天我的身心狀態都非常糟糕，甚至需要尋求醫療協助。",
            "想到可能會失去您的信任，我就感到生不如死。",
            "我寧願承受任何懲罰，也不要失去您的友誼。"
        ],
        extreme: [
            "如果您不能原諒我，我真的不知道自己是否還有活下去的意義。",
            "這幾天我完全無法正常生活，甚至產生了極端的想法。",
            "沒有您的原諒，我可能會做出一些無法挽回的事。",
            "您的原諒對我來說比生命還重要，請您大發慈悲。",
            "我已經幾天沒有好好吃飯睡覺了，整個人都快崩潰了。"
        ]
    },
    self_reflection: {
        light: [
...
${name}${getRandomElement(apologyPhrases.explanation)}${getRandomElement(apologyPhrases.consequence)}造成了${incident}。
